...
pub enum ProviderClient {
    ...
    /// Web provider — routes through the built-in web-bridge gateway.
    Web(OpenAiCompatClient),
}
...
impl ProviderClient {
    ...
    pub fn from_model_with_anthropic_auth(
        ...
        match providers::detect_provider_kind(&resolved_model) {
            ...
            ProviderKind::Web => {
                Ok(Self::Web(providers::web::create_web_client()?))
            }
        }
    }
    ...
    pub fn prompt_cache_stats(&self) -> Option<PromptCacheStats> {
        match self {
            ...
            Self::Xai(_) | Self::OpenAi(_) | Self::Web(_) => None,
        }
    }
    ...
    pub async fn send_message(
        ...
        match self {
            ...
            Self::Xai(client) | Self::OpenAi(client) | Self::Web(client) => {
    ...
    pub async fn stream_message(
        ...
        match self {
            ...
            Self::Xai(client) | Self::OpenAi(client) | Self::Web(client) => client
                .stream_message(request)
                .await
